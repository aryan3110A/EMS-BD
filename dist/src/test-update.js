...
async function test() {
    ...
    try {
        ...
        const draft = await contractsService.submit(createPayload, user);
        ...
        const result = await contractsService.update(draft.id, updatePayload, user);
...
test();
//# sourceMappingURL=test-update.js.map